...
class PersonDetect:
    ...
    def load_model(self):
    #DONE: TODO: This method needs to be completed by you
        self.core = IECore()
    ...
    def predict(self, image, w, h):
        ...
        if infer_status == 0:
            outputs = self.net.infer({self.input_name: new_image})
    ...
    #DONE: This method needs to be completed by you
        ...
        for person in coords:
            cv2.rectangle(image, (person[0], person[1]), (person[2], person[3]), (148,0,211), 1)
    ...
    #DONE: TODO: This method needs to be completed by you
        ...
        for person in outputs[0][0]:
            if person[2] > self.threshold:
                ...
                xmax = int(person[5] * w)
                ymax = int(person[6] * h)
                checked_outputs.append((xmin, ymin, xmax, ymax))
    ...
    #DONE: TODO: This method needs to be completed by you
        new_image=cv2.resize(image,(self.input_shape[3],self.input_shape[2])) 
